...
public class DBTestService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Estabelecimento est1 = new Estabelecimento("Buteco 1", "buteco1@email");
		Estabelecimento est2 = new Estabelecimento("Buteco 2", "buteco2@email");
		...
		Pedido ped2 = new Pedido(2, StatusPedido.ABERTO,sdf.parse("02/12/2017 22:23"),cli1,est1);
		Pedido ped3 = new Pedido(3, StatusPedido.ENCERRAMENTO,sdf.parse("02/12/2017 21:00"),cli2,est1);
		
		Pedido ped4 = new Pedido(4, StatusPedido.FINALIZADO,sdf.parse("02/12/2017 20:00"),cli1,est2);
		Pedido ped5 = new Pedido(5, StatusPedido.FINALIZADO,new Date(),cli2,est2);
	
		Pedido ped6 = new Pedido(100, StatusPedido.CANCELADO,sdf.parse("02/12/2017 21:00"),cli2,est1);
		
		
		Item it1 = new Item(prod1,ped1,2, StatusItem.INCLUIDO);
		Item it2 = new Item(prod2,ped1,1, StatusItem.ATENDIDO);
		Item it3 = new Item(prod3,ped3,5, StatusItem.ATENDIMENTO);
		
		Item it4 = new Item(prod4,ped4,3, StatusItem.INCLUIDO);
		Item it5 = new Item(prod5,ped5,1, StatusItem.ATENDIDO);
		
		Item it6 = new Item(prod1,ped6,10, StatusItem.INCLUIDO);
		
		Item it7 = new Item(prod1,ped1,10, StatusItem.INCLUIDO);
		...
		ped1.getItens().addAll(Arrays.asList(it7));
		...
		prod1.getItens().addAll(Arrays.asList(it7));

		
		
		pedidoRepository.save(Arrays.asList(ped1,ped2,ped3, ped4,ped5,ped6));
		
		itemRepository.save(Arrays.asList(it1,it2,it3,it4,it5,it6,it7));	
	}
}
